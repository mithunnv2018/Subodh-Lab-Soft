...
<%if(request.getParameter("REFERENCEID")!=null&&!(request.getParameter("REFERENCEID").trim().equals(""))){%>
var isEdit = true;
var parampartyid = <%=request.getParameter("REFERENCEID")%>;
<%}else{%>
var isEdit = false;	
<%}%>
...
function validation(){
	...
	if(document.getElementById('name').value == ""){
		alert("Please enter bill reference name");
		return false;
	} 
...
function editsave(){
	  ...
	  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	    {
	    	...
	    	//updateGrid();
			document.location = "billreferences.do"; 
	    	//window.location("billreferences.do");
	...
	var url = 'BillReference.do?methodtocall=edit&referenceid=<%=request.getParameter("REFERENCEID")%>&name=' + document.getElementById('name').value;
...
function savedata(){
	...
	strval = strval + '"}';
		...
		var url = 'BillReference.do?methodtocall=add&name=' + document.getElementById('name').value;	//var url='";
			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="#"> Bill Reference Master</a>
						</li>
					</ul>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-th-list"> Bill Reference Master</i> </h3>
							</div>
							<div class="box-content nopadding">
							<%JSONArray returnproject=null;%>
							<%if(request.getParameter("REFERENCEID")!=null&&!(request.getParameter("REFERENCEID").trim().equals(""))){%>
							<%JSONArray returnarr=null;%>
							<%returnarr=CommonUtil.getBillReferencesEdit(request.getParameter("REFERENCEID"));%>
							<%JSONObject returnobj=returnarr.getJSONObject(0);%>
						<form action="" method="POST" class="form-horizontal form-bordered">
									<div class="control-group">
										<label for="textfield" class="control-label">Bill Reference Name</label>
										<div class="controls">
                ...
                <div class="row-fluid">
					<div class="span12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="icon-table">Bill Reference Master List</i>
					...
					<%if(returnproject!=null){%>
							<%for(int xp1=0;xp1<returnproject.length();xp1++){%>
								...
								<tr>
									...
									<td><a href="billreferences.do?REFERENCEID=<%=objjson2.get("id")%>">Edit</a>
									</td>
								</tr>
								<%introw2=introw2+1; %>
				  			<%}%>
