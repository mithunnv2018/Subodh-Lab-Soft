...
<%JSONArray returnvalue2 =FormUtil.makeEmployeelist();%>
...
*/	
    ...
    var data_list = [
				...
				<%JSONObject objjson= returnvalue2.getJSONObject(x);%>
      				{ id: '<%=x%>', col2: '<%=objjson.get("empcatname")%>',col3:'<%=objjson.get("id")%>'}
    ...
    var layout = [[
      ...
      {name: 'Employee Category', field: 'col2' ,width: "200px"},
      {name: 'Emp id', field: 'col3' ,width: "200px", hidden:true}
    ]];
...
*/
	...
	document.getElementById("txtemployeecat").value = "";
...
function savedata(){
	...
	xmlhttp.onreadystatechange=function()
	 ...
	 // alert("hidden: " + document.getElementById("txthiddenid").value + ", edit: " + isEdit);
	  if(document.getElementById("txtemployeecat").value==""){
		...
		//alert("inside add" + document.getElementById("txthiddenid").value);
	 	...
	 	xmlhttp.open("GET","addemployeecategory.do?methodtocall=edit&txtemployeecat=" + document.getElementById('txtemployeecat').value + "&txtemployeecatid=" + document.getElementById('txthiddenid').value,true);
	 	xmlhttp.send();
		...
		xmlhttp.open("GET","addemployeecategory.do?methodtocall=add&txtemployeecat=" + document.getElementById('txtemployeecat').value,true);
		  ...
		  if (xmlhttp.readyState==4 && xmlhttp.status==200)
		    {
			    if(xmlhttp.responseText=="false"){
			    	...
			    	alert("No Such Category Exists");
				    	...
				    	isEdit=true;
				    	//alert(isEdit);
				    	document.getElementById("txtemployeecat").value = xmlhttp.responseText; 				    	
					    }
			    
		    }
		  }
		
		xmlhttp.open("GET","addemployeecategory.do?methodtocall=getEmpCatName&EmpCatId=" + document.getElementById("txthiddenid").value,true);
		xmlhttp.send();
		
	document.getElementById("txtemployeecat").value=document.getElementById("txthiddenid").value;
	}else{
...
<div id="Accordion1" class="Accordion" tabindex="0">
		  <div class="AccordionPanel">
		    <div class="AccordionPanelTab"><img src="images/man-user.png" width="20" height="20"/> Add / Modify Employee Category</div>
		   ...
		   <table border=0 width="90%">
			...
			<td>
				<input type="text" id="txtemployeecat" name="txtemployeecat" placeholder="Employee Category" size="18">
			</td>
		   	</tr>
		   	<tr>
		   	<td align="right">
			...
			<td>
				<select id="searchcolname" name="searchcolname">
	            	...
	            	<option value=" " selected="selected">Select Column Name</option>
					  <option value="col2">Employee Category</option>
