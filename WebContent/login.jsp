...
//		    clearMyGrid1();
	...
	//alert(strval);
		...
		var url = 'userlogin.do?methodtocall=login&username=' + document.getElementById('txtname').value +  '&password=' + document.getElementById('txtpassword').value;
		//var url='";
...
<div id="Accordion1" class="Accordion" tabindex="0">
		  <div class="AccordionPanel">
		    <div class="AccordionPanelTab"><img  src="images/man-user.png" width="20" height="20"/>Login</div>
		   ...
		   <table align="center" border=0   width="40%">
			...
			Username :
		   	...
		   	<td><input type="text" id="txtname" name="txtname" placeholder="Username" size="18"> </td>
		   	</tr>
		   	<tr>
		   	<td>
			Password :
		   	...
		   	<td>
		   	<input type="password" id="txtpassword" name="txtpassword" placeholder="Password" size="18">
		   	</td>
		   	</tr>
		   	<tr>
		   	<tr>
		   	...
		   	<td align="right">
		   	<input name="btnsave" onclick="savedata();" type="button" value="Login" style="background-color:#000; color:#FFF;border-color: #000;border-bottom-color: #000;border-left-color: #000;border-right-color: #000;border-top-color: #000; height: 23px;width: 45px"/>
		   	</td>
